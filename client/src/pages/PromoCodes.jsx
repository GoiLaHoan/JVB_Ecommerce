  ...
  return (
    <Helmet title="PromoCodes">
      <div className="promocodes__content">
        ...
        <ol>
          <li>
            <b>Đặt hàng</b> : Vào trang{" "}
            <Link className="promocodes__special" to="/">
              Đặt hàng nhanh
            </Link>{" "}
            hoặc{" "}
            <Link className="promocodes__special" to="/products">
              Sản phẩm
            </Link>{" "}
            để đặt hàng
          </li>
          <li>
            <b>Vào giỏ hàng</b> : Vào trang{" "}
            <Link className="promocodes__special" to="/">
              Giỏ hàng
            </Link>
          ...
          <li>
            <b>Dùng mã</b> : Nhập mã muốn dùng vào ô tìm kiếm, hoặc, chọn trong
            danh sách mã. Rồi nhấn vào nút "Dùng ngay"
          </li>
        </ol>
